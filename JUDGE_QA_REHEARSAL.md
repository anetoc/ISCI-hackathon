...
| Clinical NULL (leave-study-out) | A_persist 0.643 LPO → **0.533** LSO; CD8-frac baseline 0.585 (raw 0.58457, `b_cd8_frac/leave_study_out`) | iec_clinical/cv_results.json |
