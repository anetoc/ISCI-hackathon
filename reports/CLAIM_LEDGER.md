...
| 3 | Controllership is **strongest for canonical, axis-defining regulators** | **honest limitation** | Positive-set ablation: gain +0.25→+0.03 when GATA3/TBX21/STAT6/IRF1 removed, n=9, CI still includes original (underpowered, not null) | Not demonstrated for non-marker controllers — needs a larger independent positive set |
